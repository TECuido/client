...
struct InputBinding_Previews: PreviewProvider {
    static var previews: some View {
        InputBinding(inputText: .constant("Input") , inputPrompt: "type your input", icon: "envelope.fill", iconSize: (20, 20), iconPadding: 15, inputError: 0)
    }
}
